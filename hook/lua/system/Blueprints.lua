do
    ...
    function ModBlueprints(all_bps)
        ...
        for id, bp in all_bps.Unit do
            ...
            if bp.Defence.MaxHealth ~= nil then
            ...
            if bp.Economy and not bp.Economy.xpValue and bp.Economy.BuildCostMass and bp.Economy.BuildCostEnergy and
                bp.Economy.BuildTime and (not table.find(bp.Categories, 'UNTARGETABLE') or bp.Economy.xpBaseValue) then
                bp.Economy.xpValue = math.pow((bp.Economy.xpBaseValue or
                                                  (bp.Economy.BuildCostMass + bp.Economy.BuildCostEnergy * 0.1 +
                                                      bp.Economy.BuildTime * 0.04)), scaling)
            ...
            if bp.Categories and table.find(bp.Categories, 'EXPERIMENTAL') and
                not table.find(bp.Categories, 'STRUCTURE') then
                bp.Economy.xpTimeStep = 250
            end

            -- T1 LAND Levels faster
            if bp.Categories and table.find(bp.Categories, 'TECH1') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'AIR') and not table.find(bp.Categories, 'NAVAL') and
            ...
            if bp.Categories and table.find(bp.Categories, 'TECH1') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'AIR') and
                not table.find(bp.Categories, 'ENGINEER') then
            ...
            if bp.Categories and table.find(bp.Categories, 'TECH1') and not table.find(bp.Categories, 'STRUCTURE') and
                ...
                not table.find(bp.Categories, 'ENGINEER') then
                bp.Economy.xpTimeStep = 30 -- Aircraft die so quick anyway, might as well give them a chance
            end

            -- T2 LAND Levels faster
            if bp.Categories and table.find(bp.Categories, 'TECH2') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'AIR') and not table.find(bp.Categories, 'NAVAL') and
                not table.find(bp.Categories, 'ENGINEER') then
            ...
            if bp.Categories and table.find(bp.Categories, 'TECH2') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'NAVAL') and
                not table.find(bp.Categories, 'ENGINEER') then
                bp.Economy.xpTimeStep = 30 * 1.5 -- Aircraft die so quick anyway, might as well give them a chance
            end

            -- T3 LAND Levels faster
            if bp.Categories and table.find(bp.Categories, 'TECH3') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'AIR') and not table.find(bp.Categories, 'NAVAL') and
                not table.find(bp.Categories, 'ENGINEER') then
            ...
            if bp.Categories and table.find(bp.Categories, 'TECH3') and not table.find(bp.Categories, 'STRUCTURE') and
                not table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'NAVAL') and
                not table.find(bp.Categories, 'ENGINEER') then
                bp.Economy.xpTimeStep = (30 * 1.5) * 2 -- Aircraft die so quick anyway, might as well give them a chance
            end
            ...
            -- PowerplantXP
            if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and
                table.find(bp.Categories, 'ENERGYPRODUCTION') and not bp.Economy.xpTimeStep and
                not table.find(bp.Categories, 'UNTARGETABLE') then
            ...
            if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'TECH1') and
                not table.find(bp.Categories, 'ENERGYPRODUCTION') and not table.find(bp.Categories, 'CONSTRUCTION') and
                not table.find(bp.Categories, 'MASSPRODUCTION') and not bp.Economy.xpTimeStep and
                not table.find(bp.Categories, 'UNTARGETABLE') then
                bp.Economy.xpTimeStep = 25
            end

            -- All other structures T2
            if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'TECH2') and
                not table.find(bp.Categories, 'ENERGYPRODUCTION') and not table.find(bp.Categories, 'CONSTRUCTION') and
                not table.find(bp.Categories, 'MASSPRODUCTION') and not bp.Economy.xpTimeStep and
                not table.find(bp.Categories, 'UNTARGETABLE') then
            ...
            if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'TECH3') and
                not table.find(bp.Categories, 'ENERGYPRODUCTION') and not table.find(bp.Categories, 'CONSTRUCTION') and
                not table.find(bp.Categories, 'MASSPRODUCTION') and not bp.Economy.xpTimeStep and
                not table.find(bp.Categories, 'UNTARGETABLE') then
            ...
            -- BuildXP
            if bp.Categories and (table.find(bp.Categories, 'CONSTRUCTION') or table.find(bp.Categories, 'ENGINEER') or
                table.find(bp.Categories, 'FACTORY')) and not table.find(bp.Categories, 'UNTARGETABLE') and
                not bp.Economy.BuildxpLevelpSecond then
